 ...
 * @generated
 */
public class CgSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CgPackage.ABSTRACT_ACTION: {
			...
			case CgPackage.INPUT_ACTION: {
				...
				if (result == null) result = caseNamedElement(inputAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CgPackage.OUTPUT_ACTION: {
				OutputAction outputAction = (OutputAction)theEObject;
				T result = caseOutputAction(outputAction);
				if (result == null) result = caseAction(outputAction);
				if (result == null) result = caseAbstractAction(outputAction);
				if (result == null) result = caseNamedElement(outputAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CgPackage.COMPOSED_ACTION: {
				ComposedAction composedAction = (ComposedAction)theEObject;
				T result = caseComposedAction(composedAction);
				if (result == null) result = caseAction(composedAction);
				if (result == null) result = caseAbstractAction(composedAction);
				if (result == null) result = caseNamedElement(composedAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CgPackage.NAMED_ELEMENT: {
