 ...
 * <ul>
 *   <li>{@link cm.composition.impl.IdentifierImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class IdentifierImpl extends MinimalEObjectImpl.Container implements Identifier {
	...
	protected EClass eStaticClass() {
		return CompositionPackage.Literals.IDENTIFIER;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompositionPackage.IDENTIFIER__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompositionPackage.IDENTIFIER__ID:
				return getId();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CompositionPackage.IDENTIFIER___ID_HAS_TO_BE_UNIQUE__DIAGNOSTICCHAIN_MAP:
