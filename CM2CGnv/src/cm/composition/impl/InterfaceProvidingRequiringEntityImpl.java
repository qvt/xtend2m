 ...
 * <ul>
 *   <li>{@link cm.composition.impl.InterfaceProvidingRequiringEntityImpl#getRequiredRoles <em>Required Roles</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class InterfaceProvidingRequiringEntityImpl extends InterfaceProvidingEntityImpl implements InterfaceProvidingRequiringEntity {
	...
	protected EClass eStaticClass() {
		return CompositionPackage.Literals.INTERFACE_PROVIDING_REQUIRING_ENTITY;
	}
	...
	public EList<RequiredRole> getRequiredRoles() {
		if (requiredRoles == null) {
			requiredRoles = new EObjectContainmentWithInverseEList<RequiredRole>(RequiredRole.class, this, CompositionPackage.INTERFACE_PROVIDING_REQUIRING_ENTITY__REQUIRED_ROLES, RepositoryPackage.REQUIRED_ROLE__REQUIRING_ENTITY);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompositionPackage.INTERFACE_PROVIDING_REQUIRING_ENTITY__REQUIRED_ROLES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == InterfaceRequiringEntity.class) {
			switch (derivedFeatureID) {
				case CompositionPackage.INTERFACE_PROVIDING_REQUIRING_ENTITY__REQUIRED_ROLES: return CompositionPackage.INTERFACE_REQUIRING_ENTITY__REQUIRED_ROLES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == InterfaceRequiringEntity.class) {
			switch (baseFeatureID) {
				case CompositionPackage.INTERFACE_REQUIRING_ENTITY__REQUIRED_ROLES: return CompositionPackage.INTERFACE_PROVIDING_REQUIRING_ENTITY__REQUIRED_ROLES;
				default: return -1;
			}
		}
